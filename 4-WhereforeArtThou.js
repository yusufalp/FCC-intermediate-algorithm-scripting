 ...
 * and value pairs (second argument). Each name and value pair 
 * of the source object has to be present in the object 
 ...
 * from the array (the first argument), because it contains 
